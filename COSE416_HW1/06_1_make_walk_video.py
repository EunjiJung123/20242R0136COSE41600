...
pcd_folder = '../data/02_straight_duck_walk/pcd/'
pcd_files = sorted(glob.glob(pcd_folder + "*.pcd"))
pcd_files = pcd_files[-40:] # test code

# 비디오 저장 설정
video_filename = "../videos/02_straight_duck_walk.avi"
...
# 카메라 위치 및 뷰포인트 설정 함수
# 01 pcd 데이터 : zoom=0.08, front=[0, -1, 0.2], lookat=[-0.5, 0, 0.5], up=[0, 0, 1]
# 01 pcd 데이터 : zoom=0.03, front=[0, -1, 0.1], lookat=[-25, 10, 0], up=[0, 0, 1]
def set_camera_view(vis, zoom=0.05, front=[0, -1, 0.2], lookat=[2, 20, 0.5], up=[0, 0, 1]):
