# video로 나타낸 data 중 '06_straight_crawl'은 이 코드로 수행
# 시각화에 필요한 라이브러리 불러오기
        ...
        if cluster_id in cluster_centroids_history:
            ...
            if movement > movement_threshold:
                ...
                if not (z_max < 1.0):
                    continue
                z_diff = z_max - z_min
                if not (0.4 < width < 1.5) or not (0.0 < z_diff < 1.5):
