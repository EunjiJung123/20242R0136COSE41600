...
voxel_size = 0.1  # 필요에 따라 voxel 크기를 조정 (원래:0.5) -> 너무 크면 사람이라고 인식하지 못할 수 O
...
cl, ind = voxel_downsample_pcd.remove_radius_outlier(nb_points=20, radius=1.0)
...
# points = np.asarray(voxel_downsample_pcd.points)
